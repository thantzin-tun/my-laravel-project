      ...
      <div class="main-content">
        <div class="section__content section__content--p30">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12">
                <form class="form-header" action="{{route('user#List')}}" method="get">
                  @csrf
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <img src="{{asset('storage/'.$d->image)}}" alt="userPhoto" width="50px" height="50px" />
                      </td>
                      <td>{{$d->name}}</td>
                      <td>{{$d->email}}</td>
                      <td>{{$d->address}}</td>
                      <td>{{$d->phone}}</td>
                      <td>
                        <input type="hidden" value="{{$d->id}}" class="userID">
                        <select class="form-control bg-dark text-light role">
    ...
    $(document).ready(function() {
      ...
      $(".role").each(function(index) {
        $(this).unbind().change(function() {
          ...
          console.log($(this).val(), $('.userID').val(), userID[index].value);

          $detail = {
            id: userID[index].value,
            status: $(this).val()
          }
          ...
          $.ajax({
            type: 'get',
            data: $detail,
            url: 'http://localhost:8000/adminPage/changeRole',
            dataType: 'json',
